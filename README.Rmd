...
It is build around a single dependency: [__{stringdist}__](https://github.com/markvanderloo/stringdist), and it is possible to use the full power of the function `stringdist()` from this excellent package.
